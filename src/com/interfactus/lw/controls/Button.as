...
public class Button extends UIComponent
{
	...
	{
		_styleName = value;
		upSkin = new assets[_styleName+'_upSkin'];
		overSkin = new assets[_styleName+'_overSkin'];
		downSkin = new assets[_styleName+'_downSkin'];
		disabledSkin = new assets[_styleName+'_disabledSkin'];
	...
	override protected function createChildren():void
	{
		...
		labelTextField.defaultTextFormat = assets.buttonLabel;
