...
public class VideoPlayer extends Video
{
    ...
    public function load(url:String, isLive:Boolean = false, totalTime:Number = -1):void 
    {
        if (url == null)
        {
            var message:String = "URL NULL";//resourceManager.getString(
               // "controls", "nullURL");
    ...
    private function _play(... rest):void 
    {
        ...
        switch (rest.length) 
        {
            ...
            default:
            {
                var message:String = "Bad Arguments"//resourceManager.getString(
                    //"controls", "badArgs");
                throw new ArgumentError(message);
            }
        }
...
dynamic class VideoPlayerNetStream extends NetStream
{
    ...
    public function VideoPlayerNetStream(connection:NetConnection,
                                         videoPlayer:com.interfactus.zoe.controls.videoClasses.VideoPlayer)
    {
        super(connection);
