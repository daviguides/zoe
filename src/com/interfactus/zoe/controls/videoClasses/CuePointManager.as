...
import com.interfactus.zoe.controls.VideoDisplay;
...
public class CuePointManager 
{
    ...
    public function addCuePoint(cuePoint:Object):Object
    {
        ...
        if (timeUndefined)
        {
            message = "wrongTime";//resourceManager.getString(
                //"controls", "wrongTime");
            throw new VideoError(VideoError.ILLEGAL_CUE_POINT, message);
        }
        if (!copy.name)
        {
            message = "wrongName";//resourceManager.getString(
                //"controls", "wrongName");
            throw new VideoError(VideoError.ILLEGAL_CUE_POINT, message);
        }
                                              ...
                                              start:Number, len:Number):Number 
    {
        ...
        {
            var message:String = "wrongTimeName";//resourceManager.getString(
    ...
    private function getNextCuePointIndexWithName(name:String, array:Array, index:Number):Number 
    {
        ...
        {
            message = "wrongIndex"resourceManager.getString(
                //"controls", "wrongIndex");
            throw new VideoError(VideoError.ILLEGAL_CUE_POINT, message);
        }
