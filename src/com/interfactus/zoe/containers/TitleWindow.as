package com.interfactus.zoe.containers
{
	...
	import com.interfactus.zoe.controls.Button;
	import com.interfactus.zoe.core.Application;
	import com.interfactus.zoe.events.CloseEvent;
	...
	[Event(name="close", type="com.interfactus.zoe.events.CloseEvent")]
	public class TitleWindow extends Panel
	{
		...
		override protected function createChildren():void
		{
			...
			titleTxt.defaultTextFormat = resources.h3;
			titleTxt.x = 5;
			titleTxt.y = 3;
			titleTxt.width = 100;	
